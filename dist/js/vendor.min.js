...
angular.module("angularSlideables",[]).directive("slideable",function(){return{restrict:"C",compile:function(e){var i=e.html();return e.html('<div class="slideable_content" style="margin:0 !important; padding:1.3em 1.3em 2.5em 1.3em !important;" >'+i+"</div>"),function(e,i,t){t.duration=t.duration?t.duration:"0.3s",t.easing=t.easing?t.easing:"ease",i.css({overflow:"hidden","max-height":0,opacity:0,transitionProperty:"all",transitionDuration:t.duration,transitionTimingFunction:t.easing})}}}}).directive("slideToggle",function(){return{restrict:"A",link:function(e,i,t){var n,a;t.expanded=!1,i.bind("click",function(){n||(n=document.querySelector(t.slideToggle)),a||(a=n.querySelector(".slideable_content")),t.expanded?(n.style.maxHeight=0,n.style.opacity=.5):(n.style.maxHeight="900px",n.style.opacity=1),t.expanded=!t.expanded})}}});
