...
angular.module("angularSlideables",[]).directive("slideable",function(){return{restrict:"C",compile:function(e){var i=e.html();return e.html('<div class="slideable_content">'+i+"</div>"),function(e,i,n){n.duration=n.duration?n.duration:"0.3s",n.easing=n.easing?n.easing:"ease",i.css({overflow:"hidden","max-height":0,opacity:0,transitionProperty:"all",transitionDuration:n.duration,transitionTimingFunction:n.easing})}}}}).directive("slideToggle",function(){return{restrict:"A",link:function(e,i,n){var t,a;n.expanded=!1,i.bind("click",function(){t||(t=document.querySelector(n.slideToggle)),a||(a=t.querySelector(".slideable_content")),n.expanded?(t.style.maxHeight=0,t.style.opacity=.5):(t.style.maxHeight="1400px",t.style.opacity=1),n.expanded=!n.expanded})}}});
