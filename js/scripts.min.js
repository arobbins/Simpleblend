...
!function(){"use strict";angular.module("app",["ui.bootstrap","ui.router","ui.scrollfix","duScroll"]),angular.module("app").config(["$urlRouterProvider","$stateProvider",function(o,r){o.otherwise("/"),r.state("home",{url:"/",controller:["$scope",function(o){o.page="page-home"}]})}])}();
!function(){var e=function(e,n){e.app={},e.app.name="Simpleblend",e.work={clients:["amtrak","rewardsrus","wyndham","fraser","blueclawco","gotham","knot","octane"]};var a=angular.element(document.getElementById("about"));e.toSection2=function(){n.scrollTo(a,0,1e3)}};angular.module("app").controller("mainCtrl",["$scope","$document",e])}();
