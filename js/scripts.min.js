...
!function(){var a=function(a){a.app={},a.app.name="Simpleblend",a.work={clients:["amtrak","rewardsrus","wyndham","fraser","blueclawco","gotham","knot","octane"]}};angular.module("app").controller("mainCtrl",["$scope","$document",a])}();
