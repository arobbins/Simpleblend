...
!function(){"use strict";angular.module("app",["ui.bootstrap","ui.router","ui.scrollfix"]),angular.module("app").config(["$urlRouterProvider","$stateProvider",function(o,e){o.otherwise("/"),e.state("home",{url:"/",controller:["$scope",function(o){o.page="page-home"}]})}])}();
!function(){var a=function(a){a.app={},a.app.name="Simpleblend",a.work={clients:["amtrak","rewardsrus","wyndham","fraser","blueclawco","gotham","knot","octane"]}};angular.module("app").controller("mainCtrl",["$scope",a])}();
