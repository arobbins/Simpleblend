...
angular.module("angularSlideables",[]).directive("slideable",function(){return{restrict:"C",compile:function(e){var t=e.html();return e.html('<div class="slideable_content" style="margin:0 !important; padding:2em 2em 4em 2em !important;" >'+t+"</div>"),function(e,t,i){i.duration=i.duration?i.duration:"0.3s",i.easing=i.easing?i.easing:"ease-in-out",t.css({overflow:"hidden","max-height":0,opacity:0,transitionProperty:"all",transitionDuration:i.duration,transitionTimingFunction:i.easing})}}}}).directive("slideToggle",function(){return{restrict:"A",link:function(e,t,i){var n,a;i.expanded=!1,t.bind("click",function(){t.parent().parent().toggleClass("test"),n||(n=document.querySelector(i.slideToggle)),a||(a=n.querySelector(".slideable_content")),i.expanded?(n.style.maxHeight=0,n.style.opacity=0):(n.style.maxHeight="400px",n.style.opacity=1),i.expanded=!i.expanded})}}});
...
!function(){"use strict";angular.module("app",["ui.router","ui.scrollfix","duScroll","ngAnimate","angularSlideables"]),angular.module("app").config(["$urlRouterProvider","$stateProvider",function(e,o){e.otherwise("/"),o.state("home",{url:"/",controller:["$scope",function(e){e.page="page-home"}]})}])}();
!function(){var e=function(e){e.app={},e.app.name="Simpleblend",e.toggled=!1,e.work=[{client:"Amtrak Guest Rewards",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquet egestas augue, vel pellentesque nunc scelerisque in. Pellentesque sollicitudin egestas vulputate. Proin ligula tortor, porttitor vel accumsan blandit, laoreet sed mi. Vivamus laoreet feugiat lobortis.",link:"dfsdf",image:"logo_amtrak.svg"},{client:"Fraser",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquet egestas augue, vel pellentesque nunc scelerisque in. Pellentesque sollicitudin egestas vulputate. Proin ligula tortor, porttitor vel accumsan blandit, laoreet sed mi. Vivamus laoreet feugiat lobortis.",link:"dfsdf",image:"logo_fraser.svg"},{client:"On Being",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquet egestas augue, vel pellentesque nunc scelerisque in. Pellentesque sollicitudin egestas vulputate. Proin ligula tortor, porttitor vel accumsan blandit, laoreet sed mi. Vivamus laoreet feugiat lobortis.",link:"dfsdf",image:"logo_onbeing.svg"},{client:"Wyndham Rewards",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquet egestas augue, vel pellentesque nunc scelerisque in. Pellentesque sollicitudin egestas vulputate. Proin ligula tortor, porttitor vel accumsan blandit, laoreet sed mi. Vivamus laoreet feugiat lobortis.",link:"dfsdf",image:"logo_wyndham.svg"},{client:"Blue Claw Co.",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquet egestas augue, vel pellentesque nunc scelerisque in. Pellentesque sollicitudin egestas vulputate. Proin ligula tortor, porttitor vel accumsan blandit, laoreet sed mi. Vivamus laoreet feugiat lobortis.",link:"dfsdf",image:"logo_blueclawco.svg"},{client:"Isolate & Bloom",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquet egestas augue, vel pellentesque nunc scelerisque in. Pellentesque sollicitudin egestas vulputate. Proin ligula tortor, porttitor vel accumsan blandit, laoreet sed mi. Vivamus laoreet feugiat lobortis.",link:"dfsdf",image:"logo_isolateandbloom.svg"}]};angular.module("app").controller("mainCtrl",["$scope","$document",e])}();
